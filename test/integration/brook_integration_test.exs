defmodule Brook.IntegrationTest do
  ...
  setup do
    {:ok, redix} = Redix.start_link(host: "localhost", name: :redix)
  ...
  test "brook happy path" do
    config = [
      generator: Elsa.Group.Supervisor,
      generator_config: [
        name: :brook_elsa,
      ...
      snapshot: %{
        storage: Brook.Snapshot.RedisStorage,
        interval: 10,
        init_arg: %{redix: :redix, namespace: "test:snapshot"}
      }
    ]
